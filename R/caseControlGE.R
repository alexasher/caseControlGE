...
#' @importFrom stats binomial coef cor cov glm lm model.matrix plogis qlogis qnorm rbinom rgamma rnorm rt runif sd model.frame setNames complete.cases delete.response fitted formula logLik model.matrix.lm na.pass naprint nobs pchisq pnorm printCoefmat qt quantile residuals symnum terms vcov
